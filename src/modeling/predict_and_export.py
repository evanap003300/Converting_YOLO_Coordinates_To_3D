...
def load_model_and_scalers() -> tuple[tf.keras.Model, joblib.NumpyArrayFile, joblib.NumpyArrayFile]:
    """
...
def make_predictions(model: tf.keras.Model, x_scaler: joblib.NumpyArrayFile, 
                     y_scaler: joblib.NumpyArrayFile, df: pd.DataFrame) -> np.ndarray:
    """
